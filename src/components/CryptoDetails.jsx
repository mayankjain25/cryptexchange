...
const CryptoDetails = () => {
    ...
    if(isFetching) return <div style={{textAlign: 'center'}} className="loader"><Spin /></div>
           ...
           <Col className="coin-detail-container">
               ...
               <Col className="stats-container">
                   ...
                   <Col className="other-stats-info">
                       <Col className="coin-value-statistics-heading">
                           <Title level={3} className="coin-details-heading">
                              Other statistics, at a Glance
                           </Title>

                           <p>
                              The Crypto markets, in a nutshell
                           </p>
                       </Col>
               ...
               <Col className="coin-desc-link">
                        <Row className="coin-desc">
                            <Title className="coin-details-heading" level={3}>What is {cryptoDetails.name}</Title>
